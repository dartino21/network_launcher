...
1. Откройте страницу **Releases** на GitHub и скачайте архив `NetworkLauncher-windows-x64.zip`.
2. Распакуйте архив в обычную папку, например `C:\Programs\NetworkLauncher`.
3. Откройте `NetworkLauncher.exe`.
4. В программе нажмите **?** и выполните быструю настройку ngrok, затем выберите папку сайта.
